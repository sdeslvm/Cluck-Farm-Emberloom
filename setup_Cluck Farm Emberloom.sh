...
# Параметры
BUNDLE_ID="com.cluckfarm.emberloom"
APPLE_ID="6751858405"
REMOTE_URL="git@github.com:sdeslvm/Cluck-Farm-Emberloom.git"
PROJECT_NAME="Cluck Farm Emberloom"
SCHEME_NAME="Cluck Farm Emberloom"
