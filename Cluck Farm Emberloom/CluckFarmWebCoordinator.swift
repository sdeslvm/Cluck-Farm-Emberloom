...
class CluckFarmWebCoordinator: NSObject, WKNavigationDelegate, WKUIDelegate {
    private let callback: (CluckFarmWebStatus) -> Void
    private var didStart = false

    init(onStatus: @escaping (CluckFarmWebStatus) -> Void) {
